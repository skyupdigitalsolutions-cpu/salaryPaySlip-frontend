            ...
            ${
              formik.touched[name] && formik.errors[name]
                ...
                : readOnly
                  ...
                  : isNewEntry
                    ? "border-blue-400 bg-blue-50 focus:ring-white-500 placeholder-blue-400"
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="flex items-center gap-3 ml-2 pl-3 border-l border-white/20">
          {adminInfo && (
            <div className="hidden md:flex flex-col items-end">
              ...
              <span className="text-black/50 text-[10px] capitalize">
                {adminInfo.role}
              </span>
            </div>
          )}
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-auto overflow-hidden">
            ...
            <div className="px-6 py-6 space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={t}
                    className="flex items-center gap-1 text-[10px] text-blue-700 bg-blue-50 border border-blue-200 px-2 py-1 rounded-full font-medium"
                  >
                    <svg
            ...
            <div className="px-6 pb-6 flex gap-3 justify-end flex-wrap">
              <button
                type="button"
                onClick={() => setShowNewEmpModal(false)}
                className="px-5 py-2 text-sm font-semibold text-gray-600 border-2 border-gray-200 rounded-full hover:bg-gray-50 transition-all"
              >
                Cancel
              </button>
              <button
                ...
                className="px-6 py-2 text-sm font-bold text-white bg-[#0037CA] rounded-full shadow hover:shadow-lg hover:scale-105 transition-all duration-200 tracking-wide"
              >
      ...
      <div className="no-print form-outer-padding px-4 md:px-[150px] py-[20px]">
        <h2 className="text-lg md:text-[24px] font-semibold text-gray-800 mb-4 mt-2 text-center">
          Salary Slip Form
        </h2>
        <form onSubmit={formik.handleSubmit}>
          <div className="form-card bg-[#FFFFFF] rounded-lg w-full md:w-[1000px] px-4 ml-[100px] md:px-[90px] shadow-xl p-4 md:p-8 space-y-6">
            ...
            <div
              className={`grid grid-cols-1 md:grid-cols-2 gap-3 ${isUnknownId ? "opacity-50 pointer-events-none select-none" : ""}`}
            >
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">
                Employee Email
                <span className="ml-1.5 text-[9px] tracking-wide text-blue-600 bg-blue-50 border border-blue-200 px-1.5 py-0.5 rounded font-semibold uppercase">
                  Used to send PDF
                </span>
              </label>
              <input
      ...
      ${
        formik.touched.email && formik.errors.email
          ...
          : !isNewJoineeViaModal && fetchStatus === "found"
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-3">
                  <label className="block text-xs font-medium text-gray-700 mb-1">
                    Loss of Pay (₹)
                    <span className="ml-1.5 text-[9px] tracking-wide text-purple-700 bg-purple-50 border border-purple-200 px-1.5 py-0.5 rounded font-semibold uppercase">
                      Auto-Calculated
                    </span>
                  </label>
            ...
            <div
              className={`border rounded-md p-3 ${net > 0 ? "bg-blue-50 border-blue-200" : "bg-gray-50 border-gray-200"}`}
            >
              <div
                className={`text-sm font-semibold ${net > 0 ? "text-blue-800" : "text-gray-600"}`}
              >
                Net Salary: ₹{net.toLocaleString("en-IN")}
              </div>
              <div
                className={`text-xs mt-0.5 ${net > 0 ? "text-blue-600" : "text-gray-500"}`}
              >
                {net > 0
            ...
            {isUnknownId && (
              <div className="text-center py-1">
                <p className="text-xs text-gray-400">
                  To proceed, either enter a valid existing Employee ID above,
                  or{" "}
                  <button
                    type="button"
                    onClick={() => {
        ...
        {showPreview && (
          <div
            ref={previewRef}
            className="mt-10 bg-white shadow-xl rounded-lg p-3 md:p-6"
          >
            <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                {isNewJoinee && isNewJoineeViaModal && (
                  <span className="text-xs font-bold tracking-widest uppercase text-white bg-blue-600 px-3 py-1 rounded-full">
                    ✦ New Joinee Template
                  </span>
                )}
              </div>
      ...
      {toast && (
        <div
          className={`fixed bottom-6 right-4 left-4 md:left-auto md:right-6 z-50 flex items-center gap-3 px-5 py-3.5 rounded-xl text-sm font-medium text-white shadow-xl ${toast.type === "error" ? "bg-red-600" : "bg-[#1a3a2a]"}`}
        >
          <span className="flex-1">{toast.msg}</span>
          <button
            onClick={() => setToast(null)}
            className="ml-2 opacity-60 hover:opacity-100 text-lg leading-none flex-shrink-0"
          >
            ×
          </button>
        </div>
