    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="no-print bg-white px-4 md:px-8 py-3 flex items-center gap-4 shadow-md sticky top-0 z-40">
        <div className="flex items-center justify-center flex-shrink-0 bg-white">
          <img src="rbd-logo.webp" alt="Skyup Logo" className="h-10 w-auto object-contain" />
        </div>
...
{showPreview && (
  <div ref={previewRef} className="mt-6 sm:mt-8 bg-white rounded-xl p-3 sm:p-4 md:p-6 w-full max-w-4xl mx-auto">
    ...
    <div className="slip-outer overflow-hidden mx-auto"
      style={{ boxShadow: "0 4px 24px rgba(0,0,0,0.12)", borderRadius: "4px" }}>
      <div className="slip-inner" style={{ width: "794px", height: "1123px", transformOrigin: "top left", backgroundColor: "#ffffff" }}>
